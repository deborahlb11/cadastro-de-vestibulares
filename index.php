	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post" action="enviarDados.php">
					...
					<div class="container-login100-form-btn">
						<input type ="submit" value= "Entrar" class="login100-form-btn"></input>
					</div>
